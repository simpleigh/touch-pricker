...
describe('Changes:', () => {
    ...
    describe(
        'permute5 function',
        createChangeTests(Changes.permute5, [
    ...
    describe(
        'permuteUp function',
        createChangeTests(Changes.permuteUp, [
    ...
    describe(
        'permuteDown function',
        createChangeTests(Changes.permuteDown, [
    ...
    describe(
        'permuteBob function',
        createChangeTests(Changes.permuteBob, [
            ['2143576', Stage.Triples],
    ...
    describe(
        'permuteSingle function',
        createChangeTests(Changes.permuteSingle, [
