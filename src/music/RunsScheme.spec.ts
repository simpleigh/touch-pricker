...
describe('Runs music scheme', () => {
    ...
    testAbstractSchemeImplementation(
        ...
        [
            ...
            [S.Triples, 'xx12345', 2, '1 back 5-runs (1 12345)\n1 back 4-runs (1 2345)\n'],
            [S.Triples, 'xx23456', 2, '1 back 5-runs (1 23456)\n1 back 4-runs (1 3456)\n'],
            [S.Triples, 'xx34567', 2, '1 back 5-runs (1 34567)\n1 back 4-runs (1 4567)\n'],
            [S.Triples, 'xx54321', 2, '1 back 5-runs (1 54321)\n1 back 4-runs (1 4321)\n'],
            [S.Triples, 'xx65432', 2, '1 back 5-runs (1 65432)\n1 back 4-runs (1 5432)\n'],
            [S.Triples, 'xx76543', 2, '1 back 5-runs (1 76543)\n1 back 4-runs (1 6543)\n'],
            [S.Triples, '12345xx', 2, '1 front 5-runs (1 12345)\n1 front 4-runs (1 1234)\n'],
            [S.Triples, '23456xx', 2, '1 front 5-runs (1 23456)\n1 front 4-runs (1 2345)\n'],
            [S.Triples, '34567xx', 2, '1 front 5-runs (1 34567)\n1 front 4-runs (1 3456)\n'],
            [S.Triples, '54321xx', 2, '1 front 5-runs (1 54321)\n1 front 4-runs (1 5432)\n'],
            [S.Triples, '65432xx', 2, '1 front 5-runs (1 65432)\n1 front 4-runs (1 6543)\n'],
            [S.Triples, '76543xx', 2, '1 front 5-runs (1 76543)\n1 front 4-runs (1 7654)\n'],
            [S.Triples, '7654321', 5, '1 Reverse rounds\n1 front 5-runs (1 76543)\n1 back 5-runs (1 54321)\n1 front 4-runs (1 7654)\n1 back 4-runs (1 4321)\n'],
