...
class MbdScheme extends AbstractScheme {
    ...
    protected createMatchers(rounds: string): AbstractMatcher[] {
        ...
        if (this._stage === Stage.Triples) {
            matchers.push(
                new PatternGroup('reverse rollups', [new Pattern('7654')]),
            );
        } else {
